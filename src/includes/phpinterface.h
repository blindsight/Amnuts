...
#include <signal.h>
	// 
	// /*zend_module_entry php_amnuts_module_entry = {
	//     STANDARD_MODULE_HEADER,
	//     "amnuts", /* extension name */
...
char *amnuts_php_get_string(const char *name, size_t name_len);
...
#define AMNUTS_PHP_GET_STRINGL(name) \
    amnuts_php_get_string(name, sizeof(name))
